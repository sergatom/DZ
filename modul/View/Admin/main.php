<a href="admin/agree/" class="btn btn-info btn-lg" role="button">Предмодерация комментариев</a>

<a href="admin/addad/" class="btn btn-info btn-lg" role="button">Панель управления рекламой</a>

<a href="admin/style/" class="btn btn-info btn-lg" role="button">Внешний вид сайта</a><br>
...
<form method="post">
    ...
    <div class="form-group">
        ...
        <input name="tags" type="text" class="form-control" id="image" placeholder="Введите необходимые теги для поиска">
    </div>
